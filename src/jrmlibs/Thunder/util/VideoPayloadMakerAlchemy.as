/* 
	...
	Desc: Alchemy implementation of the flvEncoder to increase write speed
		  Technique for Alchemy memory allocation/access comes from Bernard Visscher: http://blog.debit.nl/2009/03/using-bytearrays-in-actionscript-and-alchemy/
	License: MIT
*/
