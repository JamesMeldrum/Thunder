/* 
	...
	Desc: Encodes the captured FLV asynchronously. (Wish I could spell that properly)
		  Don't instantiate this class directly. Use ByteArrayFlvEncoder or FileStreamFlvEncoder instead.
	License: MIT
*/
	...
	public class FlvEncoder
	{
		...
		public function addFrame($bitmapData:BitmapData, $uncompressedAudio:ByteArray):void
		{
			...
			if ($uncompressedAudio) 
			{
				...
				// Note: if _isAudioInputFloats is true (which is the default), 
		...
		private function makeMetaData():ByteArray
		{
			...
			var mdc:String = "Thunder FLV recorder v0.5. James Meldrum";			
