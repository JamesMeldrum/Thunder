/* 
	...
	Desc: Example of using ByteArrayFlvEncoder to create an FLV via the web
	License: MIT
*/

package jrmlibs.Thunder.views.webcam
{
	...
	import jrmlibs.Thunder.util.MicRecorderUtil;
	import jrmlibs.Thunder.util.ByteArrayFlvEncoder;
	import jrmlibs.Thunder.util.FlvEncoder;
	
	import jrmlibs.Thunder.views.webcam.uiEtc.CheckBox;
	import jrmlibs.Thunder.views.webcam.uiEtc.RecordButton;
	import jrmlibs.Thunder.views.webcam.uiEtc.States;
